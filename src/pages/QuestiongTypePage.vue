<template>
    ...
    <div class="button-container">
      <button class="custom-button">클래식한</button>
      <button class="custom-button">트렌디한</button>
      <button class="custom-button">독특한</button>
      <button class="custom-button">무난한</button>
    </div>
